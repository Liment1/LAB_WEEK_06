...
class CatViewHolder(private val containerView: View, private val imageLoader: GlideImageLoader, private val onClickListener: CatAdapter.OnClickListener) : RecyclerView.ViewHolder(containerView)  {
